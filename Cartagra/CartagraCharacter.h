...
private:
	...
	void CalculateDamage(class ACartagraCharacter* TargetHit, struct FCharacterStats& AttackerStats);
	...
	UFUNCTION()
	void OnTargetHit(class ACartagraCharacter* Target, struct FCharacterStats& AttackerStats);
